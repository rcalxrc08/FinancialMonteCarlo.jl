...
Model=NormalInverseGaussianProcess(sigma,theta1,k1,S0);
...
@test_throws(ErrorException,simulate(NormalInverseGaussianProcess(sigma,theta1,k1,S0),spotData1,mc,-T));
@test_throws(ErrorException,NormalInverseGaussianProcess(-sigma,theta1,k1,S0))
@test_throws(ErrorException,NormalInverseGaussianProcess(sigma,theta1,-k1,S0))
@test_throws(ErrorException,NormalInverseGaussianProcess(sigma,10000.0,k1,S0))