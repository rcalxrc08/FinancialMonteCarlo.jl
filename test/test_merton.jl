...
Model=MertonProcess(sigma,lam,mu1,sigma1,S0);
...
@test_throws(ErrorException,simulate(MertonProcess(sigma,lam,mu1,sigma1,S0),spotData1,mc,-T));
@test_throws(ErrorException,MertonProcess(-sigma,lam,mu1,sigma1,S0))
@test_throws(ErrorException,MertonProcess(sigma,lam,mu1,-sigma1,S0))
@test_throws(ErrorException,MertonProcess(sigma,-lam,mu1,sigma1,S0))
