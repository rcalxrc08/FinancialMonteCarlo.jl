...
The FinancialMonteCarlo package is available through the Julia package system by running `Pkg.add("FinancialMonteCarlo")`.
...
```julia
julia> using Compat, Random, FinancialMonteCarlo
...
## Using Other FinancialMonteCarlo
