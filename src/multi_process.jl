...
function pricer_macro_multiprocesses(model_type)
	@eval begin
		function pricer(mcProcess::$model_type,spotData::ZeroRateCurve,mcConfig::MonteCarloConfiguration{<: Integer , <: Integer , <: AbstractMonteCarloMethod ,  <: MultiProcess},abstractPayoff::AbstractPayoff)
