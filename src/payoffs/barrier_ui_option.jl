...
struct BarrierOptionUpIn{num1,num2,num3<:Number}<:BarrierPayoff
	T::num1
	K::num2
	barrier::num3
	isCall::Bool
	function BarrierOptionUpIn(T::num1,K::num2,barrier::num3,isCall::Bool=true) where {num1,num2,num3<:Number}
        if T <= 0.0
...
```
"""
function payoff(S::AbstractMatrix{num},barrierPayoff::BarrierOptionUpIn,spotData::equitySpotData,T1::Float64=barrierPayoff.T) where{num<:Number}
