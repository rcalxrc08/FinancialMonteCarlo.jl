...
function payoff(S::Array{abstractMatrix},euPayoff::EuropeanOptionND,rfCurve::ZeroRateCurve,T1::num2=maturity(euPayoff)) where { abstractMatrix <: AbstractMatrix{num}, num2 <: Number} where { num <: Number}
	r=rfCurve.r;
	T=euPayoff.T;
